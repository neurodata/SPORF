...
//#include "../../../src/forestTypes/unsupervisedForest/urf/unpr"
...
TEST(processingNodeUnsupervisedTest, setupRootNodeRF)
{
	...
	fpSingleton::getSingleton().setParameter("forestType", "urf");
...
TEST(processingNodeUnsupervisedTest, loadStandardRFZip)
{
...
TEST(processingNodeUnsupervisedTest, findBestSplit)
{
...
TEST(processingNodeUnsupervisedTest, moveLeftRight)
{
...
TEST(processingNodeUnsupervisedTest, moveLeft)
{
...
TEST(processingNodeUnsupervisedTest, moveRight)
{
