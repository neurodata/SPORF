...
build_tree <- function(X, Y, mtry, MinParent){
    ...
    matA <- matA[c(1:(CurrentNode-1))];

    return(list("CutVar"=CutVar,"CutPoint"=CutPoint,"ClassProb"=ClassProb,"NodeSize"=NodeSize,"Parent"=Parent,"Children"=Children, "matA"=matA));
}
