...
Definition at line 6 of file fp.\+cpp.


\begin{DoxyCode}
6                                  \{
7 \textcolor{comment}{/*}
8 \textcolor{comment}{    fp::timeLogger logTime;}
9 \textcolor{comment}{                    logTime.startFindSplitTimer();}
10 \textcolor{comment}{fp::inNodeClassIndices test(100000000);}
11 \textcolor{comment}{                    logTime.stopFindSplitTimer();}
12 \textcolor{comment}{}
13 \textcolor{comment}{logTime.startSortTimer();}
14 \textcolor{comment}{fp::stratifiedInNodeClassIndices testw(100000000);}
15 \textcolor{comment}{logTime.stopSortTimer();}
16 \textcolor{comment}{}
17 \textcolor{comment}{logTime.printGrowTime();}
18 \textcolor{comment}{*/}  
19     \textcolor{keywordflow}{try}\{
20         \hyperlink{classfp_1_1fpForest}{fp::fpForest} forest;
21         forest.\hyperlink{classfp_1_1fpForest_ad13bbbd33291ef5f523691eccc23aece}{setParameter}(\textcolor{stringliteral}{"forestType"}, \textcolor{stringliteral}{"rfBase"});
