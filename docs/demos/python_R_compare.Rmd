...
```{r r-look-at-it, fig.height = 8, fig.width = 8, dpi = 120, fig.retina= 2, eval = PLOTS}
...
```{r, fig.height = 8, fig.width = 14, dpi = 120, fig.retina= 2, eval = PLOTS}
...
```{r, fig.height = 8, fig.width = 8, dpi = 120, fig.retina= 2, eval = PLOTS}
