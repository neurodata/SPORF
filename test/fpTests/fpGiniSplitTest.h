...
TEST(fpSplit, halfSplit )
{
	...
	split<double> findSplitTest1(labels);
	returnVals = findSplitTest1.giniSplit(featureValues);
...
TEST(fpSplit, oneOffEachEnd )
{
	...
	split<double> findSplitTest1(labels);
	returnVals1 = findSplitTest1.giniSplit(featureValues);
	...
	returnVals2 = findSplitTest2.giniSplit(featureValues2);
